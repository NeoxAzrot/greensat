        ...
        <div className="py-12 md:py-20 border-t border-slate-50">
          ...
          <ul className="max-w-3xl mx-auto divide-y divide-slate-200">
            ...
            >
              ...
              avoir regardé sur sa page sur le site. Ensuite, tu n’as qu&apos;à demander lorsque tu
              passes en caisse, en précisant que tu es étudiant de l’ENSAT. Il te faudra montrer ta
              carte étudiante ou bien ta connexion sur le site afin de le prouver. N’oublie pas de
              liker la page du producteur sur le site après avoir effectué ton achat, ça nous permet
              de mieux gérer nos réductions ensuite !
            </Accordion>
            ...
            <Accordion title="Je connais un producteur ou un commerçant qui pourrait rejoindre le projet, est-ce possible ?">
              ...
              rencontres, avec dans l’objectif d’agrandir ce réseau que nous formons. Si tu connais
              quelqu’un d&apos;intéressé, contacte-nous sur insta ou par mail et nous ferons notre
              possible pour intégrer le nouveau candidat !
            </Accordion>
            ...
            <Accordion title="Je n’ai pas internet sur mon téléphone, comment puis-je utiliser cette application ?">
              Tu peux simplement repérer les producteurs avant de partir faire tes courses et t’y
              rendre avec ta carte ou l’autocollant du projet !
            </Accordion>
