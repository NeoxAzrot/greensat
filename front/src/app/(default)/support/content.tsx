              ...
              <div className="flex">
                ...
                <div className="grow">
                  ...
                  <p className="text-slate-500 mb-4">
                    New to Tidy or feeling a little lost? Start here ;)
                  </p>
            ...
            >
              <div className="flex">
                ...
                <div className="grow">
                  ...
                  <p className="text-slate-500 mb-4">
                    Practical platform tips and recommendations.
                  </p>
                  <footer className="flex items-center">
                    <div className="flex shrink-0 -space-x-3 -ml-0.5 mr-3">
                      <Image
            ...
            >
              <div className="flex">
                ...
                <div className="grow">
                  ...
                  <p className="text-slate-500 mb-4">
                    Tutorials, FAQs and best practices with tools like Tidy Pro, Tidy Tracker, and
                    more.
                  </p>
                  <footer className="flex items-center">
                    <div className="flex shrink-0 -space-x-3 -ml-0.5 mr-3">
