        ...
        <div className="pt-8 mb-8">
          <div className="prose text-lg text-slate-500 max-w-none prose-lg prose-p:leading-normal prose-headings:font-playfair-display prose-headings:text-slate-900 prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-a:font-medium prose-strong:font-medium prose-strong:text-slate-900 prose-blockquote:pl-4 prose-blockquote:border-l-2 prose-blockquote:border-slate-900 prose-blockquote:not-italic prose-blockquote:font-normal prose-blockquote:text-inherit before:prose-p:content-[''] after:prose-p:content-[''] prose-hr:my-8">
            ...
            <p>
              ...
              responsable. De la même façon, les mentions légales peuvent être modifiées à tout
            ...
            <p>
              ...
              responsable des oublis, des inexactitudes et des carences dans la mise à jour,
            ...
            <p>
              ...
              et l’hébergeur ne pourront être tenus responsables en cas de dysfonctionnement du
              réseau Internet, des lignes téléphoniques ou du matériel informatique et de téléphonie
              lié notamment à l’encombrement du réseau empêchant l’accès au serveur.
            </p>
            ...
            <p>
              ...
              ne pourra être tenu responsable des dommages directs et indirects causés au matériel
            ...
            <p>
              ...
              dans cet espace qui contreviendrait à la législation applicable en France, en
              particulier aux dispositions relatives à la protection des données. Le cas échéant,{' '}
              <Link href="/" aria-label="Accueil">
                greensatable.fr
              </Link>{' '}
            ...
            <p>
              ...
              est représenté par Lise Michel, son représentant légal.
            </p>
            ...
            <p>
              ...
              à ses prospects et clients, à partir de la collecte de leurs consentements, une
              information complète sur le traitement de leurs données personnelles et de maintenir
            ...
            <p>
              ...
              s’engage à détruire ses données, sauf si leur conservation s’avère nécessaire à des
            ...
            <p>
              Concernant les utilisateurs du Site{' '}
              <Link href="/" aria-label="Accueil">
                greensatable.fr
              </Link>
            ...
            <p>
              ...
              n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera
            ...
            <p>
              ...
              est susceptible de traiter les informations de l’Utilisateur concernant sa visite du
              Site, telles que les pages consultées, les recherches effectuées. Ces informations
              permettent à{' '}
              <Link href="/" aria-label="Accueil">
                greensatable.fr
              </Link>{' '}
            ...
            <p>
              ...
              informe l’Utilisateur que, dans ce cas, il se peut que les fonctionnalités de son
            ...
            <p>
              ...
              décline toute responsabilité pour les conséquences liées au fonctionnement dégradé du
              ...
              configuration de chaque navigateur est différente. Elle est décrite dans le menu
              d’aide du navigateur, qui permettra de savoir de quelle manière l’Utilisateur peut
            ...
            <p>
              ...
              balises d’action, GIF à un pixel, GIF transparents, GIF invisibles et GIF un à un) et
              les déployer par l’intermédiaire d’un partenaire spécialiste d’analyses Web
              susceptible de se trouver (et donc de stocker les informations correspondantes, y
            ...
            <p>
              ...
              exemple, le nombre de fois où une page est ouverte et les informations consultées),
            ...
            <p>
              ...
              fait attribution exclusive de juridiction aux tribunaux compétents de Toulouse.
            </p>
