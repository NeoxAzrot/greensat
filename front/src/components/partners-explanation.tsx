          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-lg text-slate-500">
              ...
              <p className="mb-8">
                ...
                et la solidarité. Nous offrons l&apos;adhésion aux étudiants pour leur permettre de
              ...
              <p className="mb-8">
                ...
                c&apos;est grâce à ce dispositif que nous avons pu nous lancer.
              </p>
            </div>
          </div>
        </div>
...
export default PartnersExplanation;
