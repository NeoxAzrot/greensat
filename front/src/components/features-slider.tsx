...
const FeaturesSlider = () => {
  ...
  const handleClick = (e: MouseEvent<HTMLButtonElement>, newTabIndex: number) => {
    e.preventDefault();
    setTab(newTabIndex);
  };
              ...
              <div className="relative flex flex-col" data-aos="fade-up" ref={tabs}>
                ...
                >
                  <Image
                    ...
                    height={474}
                    loading="lazy"
                    alt="Marché de fruits et légumes"
                  />
                </Transition>
                ...
                >
                  <Image
                    ...
                    height={474}
                    loading="lazy"
                    alt="Étudiants en train de réviser"
                  />
                </Transition>
              </div>
            </div>
